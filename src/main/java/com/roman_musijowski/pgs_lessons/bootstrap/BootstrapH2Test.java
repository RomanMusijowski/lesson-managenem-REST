...
@Component
@Profile("default")
public class BootstrapH2Test implements CommandLineRunner {

    private static final Logger logger = LoggerFactory.getLogger(BootstrapH2Test.class);
    ...
    @Autowired
    public BootstrapH2Test(LessonService lessonService, RoleService roleService, UserService userService
            , UserMapper userMapper, RoleMapper roleMapper, LessonMapper lessonMapper) {
